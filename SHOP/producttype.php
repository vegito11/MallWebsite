...
<html lang="en">
  ...
  <head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1">
  	...
  	<title> Employee Sale Records </title>
	    <link rel="stylesheet" type="text/css" href="protype1.css">
  ...
  ?>
    ...
    <ul class="nav">
      ...
      <li><a href="producttype.php" class="active">Products With Type </a></li>
    ...
    <div class="sidebar">
          <form action="producttype.php" class="form-inline" method="POST">
